...
def setModelParametersFromFile(paramsFromFile):
  ...
  params['lambda_Vtilde']          = tf.constant(1.38,                                 dtype=tf.float64);
  params['Vtilde_bar']             = tf.constant(0.716,                                dtype=tf.float64);
  ...
  params['psi_e']                  = tf.constant(paramsFromFile['rho_e'],              dtype=tf.float64);  ### Mismatch from MFR to notation?
  params['psi_h']                  = tf.constant(paramsFromFile['rho_h'],              dtype=tf.float64);  ### Mismatch from MFR to notation?
  ...
  params['sigma_Vtilde_norm']      = tf.constant(0.12,                                 dtype=tf.float64);
  ...
  params['cov44']                  = tf.constant(1.0,                                  dtype=tf.float64);
  ...
  params['VtildeMin'] = params['Vtilde_bar'] - params['numSds'] * tf.sqrt(vtildeVar)
  params['VtildeMax'] = params['Vtilde_bar'] + params['numSds'] * tf.sqrt(vtildeVar)
  params['VtildeMin'] = tf.constant(0.0,               dtype=tf.float64)
  params['VtildeMax'] = tf.constant(0.0,               dtype=tf.float64)
